...
export const index = (req, res) => { 
  ...
  if (searchTerm || (filterType && filterType !== "all") || minRuntime || maxRuntime || ratings || minGrade || maxGrade || startDate || endDate) {
    if (searchTerm) {
    ...
    if (minGrade) {
      filterClauses.push(`COALESCE(grade, grade_tv) >= $${paramIndex++}`);
