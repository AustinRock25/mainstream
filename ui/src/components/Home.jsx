  ...
  return (
    <Container className="pt-3 text-center">
      ...
      <p className="text-white-50 small">
        If you don't see a certain movie/show in this database, that means I haven't seen/finished it yet and I will watch it soon, or that it doesn't fit my criteria, which are the following: a film has to have a runtime of 40 minutes or more, and each episode in a TV show has to have a runtime of 20 minutes or more, and no pornography.
      </p>
