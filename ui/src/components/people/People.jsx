        ...
        <Row className="justify-content-center">
          <Col md={8} lg={6} className="d-flex">
            <Form.Control
              ...
              className="me-2"
            />
            <Button variant="success" type="submit" className="me-2 flex-shrink-0" disabled={isLoading}>Search</Button>
            ...
            ?
              <>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <h6 className="fw-bolder text-white mb-0">{(filters.searchTerm || filters.birthDateRange.start || filters.birthDateRange.end || filters.noBirthDate || filters.deathDateRange.start || filters.deathDateRange.end || filters.noDeathDate) ? "" : `Born ${new Date().getUTCMonth() + 1}/${new Date().getUTCDate()}`}</h6>
