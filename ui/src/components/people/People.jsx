            ...
            ?
              <>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <h6 className="fw-bolder text-white mb-0">{(filters.searchTerm || filters.birthDateRange.start || filters.birthDateRange.end || filters.noBirthDate || filters.deathDateRange.start || filters.deathDateRange.end || filters.noDeathDate) ? "" : `Born ${new Date().getUTCMonth()}/${new Date().getUTCDate()}`}</h6>
