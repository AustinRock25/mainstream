      ...
      <Modal.Body>
        ...
        <Row>
          <Col xs={12} md={4} className="text-center mb-4 mb-md-0">
            ...
            />
            {media.seasons.length > 1 && media.type == "show" && !!user && user.rating_scale == 1 && <p className={`fw-bold fs-5 text-${media.seasons[currentSeason].grade < (175/4) ? "danger" : media.seasons[currentSeason].grade < (225/4) ? "warning" : "success"}`}>{getGradeSeason(media.seasons[currentSeason])}</p>}
            {media.seasons.length > 1 && !user || (media.type == "show" && !!user && user.rating_scale == 2) && <p className={`fw-bold fs-5 text-${media.seasons[currentSeason].grade < (175/5) ? "danger" : media.seasons[currentSeason].grade < (325/5) ? "warning" : "success"}`}>{getGradeSeason(media.seasons[currentSeason])}</p>}
            {media.seasons.length > 1 && media.type == "show" && !!user && user.rating_scale == 3 && <p className={`fw-bold fs-5 text-${media.seasons[currentSeason].grade < (375/10) ? "danger" : media.seasons[currentSeason].grade < (625/10) ? "warning" : "success"}`}>{getGradeSeason(media.seasons[currentSeason])}</p>}
