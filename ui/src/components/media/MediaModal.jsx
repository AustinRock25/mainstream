                ...
                <Accordion flush>
                  {media.seasons[currentSeason].episodes.sort((a, b) => (a.episode > b.episode ? 1 : -1)).map((ep, index) => (
                    <Accordion.Item eventKey={index.toString()} key={index} className="border-0">
                      <Accordion.Header className="w-100 d-flex align-items-center justify-content-between">
                        ...
                        <span className="fs-5 fw-bold opacity-50 ms-auto Stext-nowrap">{time(ep.runtime)}</span>
                      </Accordion.Header>
