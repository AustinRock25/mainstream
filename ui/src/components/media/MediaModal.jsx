        ...
        <Modal.Title className="w-100">
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex flex-column flex-md-row gap-xs-1 gap-md-4">
              ...
              {media.type == "movie" && (<span className={`fw-bold fs-5 text-${Math.round(((Math.round((Number.parseFloat((media.grade / 100) * (user.rating_scale_max - user.rating_scale_min)) + Number.parseFloat(user.rating_scale_min)) * 2) / 2) * 100) / (user.rating_scale_max - user.rating_scale_min)) <= 39 ? "danger" : Math.round(((Math.round((Number.parseFloat((media.grade / 100) * (user.rating_scale_max - user.rating_scale_min)) + Number.parseFloat(user.rating_scale_min)) * 2) / 2) * 100) / (user.rating_scale_max - user.rating_scale_min)) <= 60 ? "warning" : "success"}`}>{getGrade(media)}</span>)}
              {media.type == "show" && (<span className={`fw-bold fs-5 text-${Math.round(((Math.round((Number.parseFloat((media.grade_tv / 100) * (user.rating_scale_max - user.rating_scale_min)) + Number.parseFloat(user.rating_scale_min)) * 2) / 2) * 100) / (user.rating_scale_max - user.rating_scale_min)) <= 39 ? "danger" : Math.round(((Math.round((Number.parseFloat((media.grade_tv / 100) * (user.rating_scale_max - user.rating_scale_min)) + Number.parseFloat(user.rating_scale_min)) * 2) / 2) * 100) / (user.rating_scale_max - user.rating_scale_min)) <= 60 ? "warning" : "success"} mb-0`}>{getGrade(media)}</span>)}
            </div>
          </div>
        </Modal.Title>
      </Modal.Header>
